@humewithoutSigninfeature @Getstarted
...
Scenario:Verify that user able to see warning message while selecting "<Option>" from the drop down
Given The user is on the Home page
...
Scenario: Verify that user able to see warning message on clicking Get Started buttons of "<TabName>" Heading on the home page
Given The user is on the Home page
