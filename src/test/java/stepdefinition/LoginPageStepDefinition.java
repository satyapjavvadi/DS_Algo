...
public class LoginPageStepDefinition {
	...
	@Given("the user provides  and ")
	public void the_user_provides_and() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	@Given("the user provides validUser and ")
	public void the_user_provides_valid_user_and() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Given("the user provides  and validPass")
	public void the_user_provides_and_valid_pass() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Given("the user provides typoUser and validPass")
	public void the_user_provides_typo_user_and_valid_pass() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	@Given("the user provides validUser and typoPass")
	public void the_user_provides_valid_user_and_typo_pass() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void the_user_should_be_redirected_to_the_home_page_with_a_message(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void the_user_should_be_able_to_see_the_link(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
