...
public class LinkedListPageStepDefinition {
	...
	@Given("the signed-in user has navigated to the {string} page")
	...
	@When("the user activates the {string} button in Linked List page")
	...
	public void user_must_be_navigated_to_Linked_List_code_editor() {
	...
	@Then("User must see list of questions in {string} of Linked List")
	...
	@When("User clicks on Practice Questions link in Linked List {string} UI")
	public void user_clicks_on_practice_questions_link_in_linked_list_ui(String topicPage) {
		pom.getLinkedListPage().clickTopicLink(topicPage);
		pom.getLinkedListPage().clickPracticeQuestionsLink();
